...
# OR
git fetch
git push --set-upstream origin <dev> # there is origin/<dev> 
~~~
...
Remove from git, not from system (it will still be there on your computer),
