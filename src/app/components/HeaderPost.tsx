...
export function SkeletonHeaderPost() {
  return (
    <Header className="flex flex-col items-center gap-4 lg:flex-row">
      <div className="flex w-full shrink-0 flex-row items-center gap-4 lg:w-fit">
        {/* Icon skeleton */}
        <div className="h-[75px] w-[75px] animate-pulse rounded bg-gray-200 lg:h-[150px] lg:w-[150px]" />

        {/* Mobile title skeleton */}
        <div className="h-8 w-48 animate-pulse rounded bg-gray-200 lg:hidden" />
      </div>

      <div className="flex w-full flex-col gap-4">
        {/* Desktop title skeleton */}
        <div className="hidden h-9 w-96 animate-pulse rounded bg-gray-200 lg:block" />
